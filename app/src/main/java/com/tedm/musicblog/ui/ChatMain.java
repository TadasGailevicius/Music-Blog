...
import com.tedm.musicblog.R;
import com.tedm.musicblog.adapters.ChatroomRecyclerAdapter;
import com.tedm.musicblog.models.Chatroom;
...
import static com.tedm.musicblog.Constants.ERROR_DIALOG_REQUEST;

public class ChatMain extends AppCompatActivity implements
        ...
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        settings = FirebaseFirestore.getInstance().getFirestoreSettings();
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(ChatMain.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(ChatMain.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
    ...
    private void navChatroomActivity(Chatroom chatroom){
        Intent intent = new Intent(ChatMain.this, ChatroomActivity.class);
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(ChatMain.this, "Enter a chatroom name", Toast.LENGTH_SHORT).show();
                }
            }
        });
